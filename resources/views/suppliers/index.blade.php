    ...
    <div class="panel shadow">
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <button type="button" class="btn btn-primary" data-toggle="modal" id="btn-supplier-add">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        {!! $dataTable->table(['class' => 'table table-bordered table-striped table-hover','id' => 'dataTables-supplier-list']) !!}
                    </div>
                </div>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        ...
        $('#btn-supplier-add').click(function () {
