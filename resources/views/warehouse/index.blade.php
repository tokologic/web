...
@section('content')
    ...
    <div class="panel shadow">
        <div class="panel-heading">
            <div class="pull-left">
                <h3 class="panel-title">Gudang</h3>
            </div>
            <div class="pull-right">
                <button type="button" class="btn btn-primary" data-toggle="modal" id="btn-warehouse-add">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        {!! $dataTable->table(['class' => 'table table-bordered table-striped table-hover','id' => 'dataTables-warehouse-list']) !!}
                    </div>
                </div>
            </div>
        </div>
...
@push('script')
    ...
    <script>
        ...
        $('#btn-warehouse-add').click(function () {
